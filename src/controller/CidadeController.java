...
public class CidadeController {
    ...
    public boolean atualizar(int id, Cidade cidade) {
        return cidadeRepository.atualizar(id, cidade);
    }

    public void cadastrarComIA() {

        GeminiService gemini = new GeminiService();

        System.out.println(gemini.gerarCidade());
    }
}